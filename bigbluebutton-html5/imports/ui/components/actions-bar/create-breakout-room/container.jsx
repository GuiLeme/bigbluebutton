...
const CreateBreakoutRoomContainer = (props) => {
  const { allowUserToChooseABreakoutByDefault } = METEOR_SETTINGS_APP.breakouts;
  ...
  const captureNotesByDefault = METEOR_SETTINGS_APP.breakouts.captureNotesByDefault
  ...
  return (
    ...
    && (
      <CreateBreakoutRoomModal 
        {...props}  
        {...{
          allowUserToChooseABreakoutByDefault,
          captureWhiteboardByDefault,
          captureNotesByDefault,
        }}
      />
    )
  );
